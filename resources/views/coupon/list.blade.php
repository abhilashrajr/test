          ...
          <div class="col-md-12">
               <div class="card">
                    <div class="card-header">
                         <h4 class="card-title" style="padding-left:20px;">Coupons</h4>
                    </div>
                    <div class="card-body">
                         <div class="bootstrap-table">
                              <div class="fixed-table-toolbar">
                                   ...
                                   <div class="columns columns-right pull-right mt-0" >
                                        <a href="{{ route('coupon.create')}}" style="font-size:16px;padding: 7px 20px;"
                                        ...
                                        <form method="get" action="" class="form-inline">
                                             ...
                                             <div class="form-group" style="padding-right: 5px;margin-bottom:0px;">
                                                  ...
                                                  <select name="type" class="form-control" id="sel1">
                                                      ...
                                                      <!-- <option value="1" {{ Request()->type == '1' ? "selected" : "" }}>For All </option>-->
                                                       <option value="2" {{ Request()->type == '2' ? 'selected' : '' }}>Collection only 
                                                       </option>
                                                       <option value="3" {{  Request()->type  == '3' ? 'selected' : '' }}>Delivery only
                                                       </option>
                                                       <option value="4" {{  Request()->type  == '4' ? 'selected' : '' }}>Delivery & Collection
                                                       </option>
                                                      <!-- <option value="5" {{  Request()->type  == '5' ? 'selected' : '' }}>Dine in only
                                                       </option>
                                                       <option value="6" {{  Request()->type  == '6' ? 'selected' : '' }}>Pay Now only
                                                       </option>
                                                       <option value="7" {{  Request()->type  == '7' ? 'selected' : '' }}>Booking only
                                                       </option>-->
                                                  </select>
                                             </div>
                                             ...
                                             <table id="bootstrap-table" class="table table-hover table-sm "
                                                  ...
                                                  <thead>
                                                       <tr>
                                                            ...
                                                            <th class="text-center">
                                                                 <div class="th-inner ">@sortablelink('type',
                                                                      'Type')</div>
                                                                 <div class="fht-cell"></div>
                                                            </th>
                                                            <th>
                                                  ...
                                                  <tbody>
                                                       ...
                                                       <tr>
                                                            ...
                                                            <td class="text-center">{{ $item->reduction==1 ? '£' :''}}{{ $item->value+0 }}{{ $item->reduction==2 ? '%' : ''}}</td>
                                                            
                                                            
                                                            <td class="text-center">
                                                                 <label class="switch">
                                                                      <input type="checkbox"  class="switch-class"    data-name="coupon"  data-id="{{$item->id}}" autocomplete="off"{{ $item->active==1 ? 'checked': '' }}>
                                                                 ...
                                                                 <form action="{{ route('coupon.destroy', $item->id) }}"
                                                                      ...
                                                                      <div class="table-icons">
                                                                           <a  title="Edit"
                                                                                ...
                                                                                href="{{ route('coupon.edit', $item->id)}}"
