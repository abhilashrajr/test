                         ...
                         <div class="card-body">
                              ...
                              <div class="form-group">
                                   ...
                                   <select name="menu_type"
                                        ...
                                        <option value="{{ $m_type->id }}"
                                             {{ $menu->menu_type_id == $m_type->id ? 'selected' : '' }}>{{ $m_type->name }}
                                        </option>
                                        @endforeach
                                   </select>
                              ...
                              <div class="form-group" style="">
                                   ...
                                   <select name="category"
                                        ...
                                        <option value="{{ $cat->id }}"
                                             {{ $menu->category_id == $cat->id ? 'selected' : '' }}>{{ $cat->name }}
                                        </option>
                                        @endforeach
                                   </select>
                              ...
                              <div class="row ">
                                             ...
                                             <label class="form-check-label">
                                                 Badge  </label>
                                                  <select name="best_seller" class="form-control" id="sel2">
                                                        <option value="0" {{ $menu->best_seller == '0' ? 'selected' : '' }}>None
                                                       <option value="1" {{ $menu->best_seller == '1' ? 'selected' : '' }}>Best Seller
                                                       </option>
                                                       <option value="2" {{ $menu->best_seller == '2' ? 'selected' : '' }}>Must Try
                                                  </option>
                                                  <option value="3" {{ $menu->best_seller == '3' ? 'selected' : '' }}>Hot
                                                  </option>
                                                  <option value="4" {{ $menu->best_seller == '4' ? 'selected' : '' }}>Spicy
                                                  </option>
                                   ...
                                   <div class="col">
                                        <div class="form-group">
                                             ...
                                             <option value="0" {{ $menu->veg == '0' ? 'selected' : '' }}>No
                                                  </option>
                                                  <option value="1" {{ $menu->veg == '1' ? 'selected' : '' }}>Yes
                                                  </option>
                                                  </select>
                                        </div>
                                   </div>
                                   ...
                                   <div class="col">
                                        <div class="form-group">
                                             ...
                                             <select name="active" class="form-control" id="sel2">
                                                  <option value="1" {{ $menu->active == '1' ? 'selected' : '' }}>Yes
                                                  </option>
                                                  <option value="0" {{ $menu->active == '0' ? 'selected' : '' }}>No
                                                  </option>
                                             </select>
                                        </div>
                                   </div>
                    ...
                    <div class="card">
                         ...
                         <div class="card-body">
                              <div id="accordion" class="myaccordion">
                                   ...
                                   <div class="card" data-id="{{$key}}">
                                        <h5 class="card-header "  data-background-color="#F3F2EE" role="tab"
                                             ...
                                             <a class="collapsed d-block" data-toggle="collapse"
                                                  ...
                                                  <i class="fa fa-chevron-down pull-right"></i> {{$data[$key]['category']}}
                                             </a>
                                        </h5>
                                             ...
                                             <div class="card-body">
                                                  <div class="table-responsive">
                                                       <table id="bootstrap-table"
                                                            ...
                                                            <tr>
                                                                 <td><input name="btSelectAll" type="checkbox"> Check
                                                                      All
                                                                 </td>
                                                                 <td><input name="addon[{{$key}}][required]" type="checkbox" value="1" {{empty($madata[$key]['required']) ? '':'checked'}}> Required
                                                                 </td>
                                                                 <td><input name="addon[{{$key}}][multiple]" type="checkbox" value="1" {{empty($madata[$key]['multiple']) ? '':'checked'}}> Multiple
                                                                 </td>
                                                            </tr>
                                                       </table>
                                                  </div>
                                                  <div class="table-responsive">
                                                       <table id="bootstrap-table"
                                                            ...
                                                            <tbody>
                                                                 ...
                                                                 <tr>
                                                                      <td class="text-center"><input name="addon[{{$key}}][items][{{$i}}][id]" type="checkbox" value="{{$item['item_id']}}" {{empty($madata[$key]['items'][$k]['item_id']) ? '':'checked'}}>
                                                                      </td>
                                                                      <td>{{$item['name']}}
                                                                      </td>
                                                                      <td>{{$item['price']}}</td>
                                                                      <td>  <input type="number" name="addon[{{$key}}][items][{{$i}}][min]" 
                                        class="form-control p-2 bg-light {{ $errors->has('price') ? 'has-error' : '' }}"
                                        value="{{$madata[$key]['items'][$k]['min'] ?? 1}}" min="1"  style="max-width: 90px;min-width: 50px;"></td>
                                                                      <td>  <input type="number" name="addon[{{$key}}][items][{{$i}}][max]" 
                                        class="form-control p-2 bg-light {{ $errors->has('price') ? 'has-error' : '' }}"
                                        value="{{$madata[$key]['items'][$k]['max'] ?? 1}}" min="1"  style="max-width: 90px;min-width: 50px;"></td>
                                                                 </tr>
                                                                 @php 
                                                                 $i++;
                                                                 @endphp
                                   ...
                                   <div class="card" data-id="{{$key}}">
                                        <h5 class="card-header bg-light" data-background-color="#F3F2EE" role="tab"
                                             id="heading{{$key}}">
                                             <a class="collapsed d-block" data-toggle="collapse"
                                                  data-parent="#accordion" href="#collapse{{$key}}"
                                                  aria-expanded="false" aria-controls="collapse{{$key}}">
