          ...
          <div class="col-md-12">
               <div class="card">
                    <div class="card-header">
                         <h4 class="card-title" style="padding-left:20px;">Vouchers</h4>
                    </div>
                    <div class="card-body">
                         <div class="bootstrap-table">
                              <div class="fixed-table-toolbar">
                                   ...
                                   <div class="columns columns-right pull-right mt-0" >
                                        <a href="{{ url('voucher/create') }}" style="font-size:16px;padding: 7px 20px;"
                                   ...
                                   <div class="pull-left search">
                                        <form method="get" action="" class="form-inline">
                                             ...
                                             <div class="form-group w-25" style="padding-right: 5px;margin-bottom:0px;">
                                             <input class="form-control w-100" type="text" name="price"
                                                       placeholder="Price" value="{{ Request()->price ?? ''}}" style="height: calc(2.25rem + 2px);">
                                             ...
                                             <table id="bootstrap-table" class="table table-hover table-sm "
                                                  ...
                                                  <tbody>
                                                       ...
                                                       <tr>
                                                            ...
                                                            <td style="">{{ $voucher->name }}</td>
                                                            <td style="">{{  \Illuminate\Support\Str::limit($voucher->description, 30) }}</td>
                                                            <td style="">
                                                                 {{ $voucher->price}}
                                                            </td>
                                                            <td class="text-center">{{ $voucher->sort_order }}</td>
                                                            <td class="text-center">
                                                                 <label class="switch">
                                                                      <input type="checkbox"  class="switch-class"    data-name="voucher"  data-id="{{$voucher->id}}" autocomplete="off"{{ $voucher->active==1 ? 'checked': '' }}>
