        ...
        <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="card card-stats">
                        ...
                        <div class="row">
                            ...
                            <div class="col-7 col-md-8">
                                <div class="numbers">
                                    ...
                                    <p class="card-title">£ {{number_format($card_data->revenue + $cash_data->revenue)}}
                                        <p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-footer ">
                        <hr>
                        <div class="stats">
                            <i class="fa fa-info-circle"></i> {{$card_data->total + $cash_data->total}} Orders
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="card card-stats">
                        ...
                        <div class="row">
                            ...
                            <div class="col-7 col-md-8">
                                <div class="numbers">
                                    ...
                                    <p class="card-title">£ {{number_format($card_data->revenue)}}
                                        <p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-footer ">
                        <hr>
                        <div class="stats">
                            <i class="fa fa-info-circle"></i> {{$card_data->total}} Orders
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="card card-stats">
                        ...
                        <div class="row">
                            ...
                            <div class="col-7 col-md-8">
                                <div class="numbers">
                                    ...
                                    <p class="card-title"> £ {{number_format($cash_data->revenue)}}
                                        <p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-footer ">
                        <hr>
                        <div class="stats">
                            <i class="fa fa-info-circle"></i> {{$cash_data->total}} Orders
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-7 col-md-8">
                                <div class="numbers">
                                    ...
                                    <p class="card-title">{{$cash_data->total}}
                                        <p>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-md-12">
                <div class="card ">
                    <div class="card-header ">
                        ...
                        <p class="card-category">Past Months performance</p>
                    </div>
                    <div class="card-body ">
