                    ...
                    <div class="card-body">
                         ...
                         @csrf
                              ...
                              <div class="form-group">
                                   ...
                                   <input type="text" name="name" placeholder="Category Name" class="form-control  {{ $errors->has('name') ? 'has-error' : '' }}"
                                        value="{{old('name')}}">
                                   @if ($errors->has('name'))
                              ...
                              <div class="form-group">
                                   ...
                                   @foreach($menu_types as $m_type)
                                       <option value="{{ $m_type->id }}" {{ old('menu') == $m_type->id ? 'selected' : '' }}>{{ $m_type->name }}</option>
                                   @endforeach    
                                   </select>
                              </div>
                              <div class="form-group">
