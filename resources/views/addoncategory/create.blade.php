          ...
          <div class="col-12 col-sm-12 col-md-12  col-lg-8 col-xl-6">
                ...
                <div class="card">
                    <div class="card-header">
                         <h4 class="card-title">Add Addon Category</h4>
                    </div>
                    <div class="card-body">
                         <form method="POST" action="{{ route('addoncategory.store') }}" enctype="multipart/form-data">
                         @csrf
                         
                              <div class="form-group">
                                   <label>Name<star>*</star></label>
                                   <input type="text" name="name" placeholder="Addon Category Name" class="form-control  {{ $errors->has('name') ? 'has-error' : '' }}"
                                        value="{{old('name')}}">
                                   @if ($errors->has('name'))
                              ...
                              <div class="form-group">
                                   ...
                                   <textarea class="form-control" name="description" placeholder="Addon Category Description"
                                        rows="3">{{old('description')}}</textarea>
                              </div>
                              <div class="form-group">
                                   <label>Addon Category Image</label>
