          ...
          <div class="col-md-12">
               <div class="card">
                    <div class="card-header">
                         <h4 class="card-title" style="padding-left:20px;">Addon Categories</h4>
                    </div>
                    <div class="card-body">
                         <div class="bootstrap-table">
                              <div class="fixed-table-toolbar">
                                   ...
                                   <div class="columns columns-right pull-right mt-0" >
                                        <a href="{{ url('addoncategory/create') }}" style="font-size:16px;padding: 7px 20px;"
                                             ...
                                             <table id="bootstrap-table" class="table table-hover table-sm "
                                                  ...
                                                  <tbody>
                                                       ...
                                                       <tr>
                                                            ...
                                                            <td style=""><a href="{{ route('addonitem.index', ['addon_categories_id' => $category->id]) }}" style="color:#000;text-decoration: underline;">{{ $category->name }}</a></td>
                                                            <td style="">{{ $category->description }}</td>
                                                            <td class="text-center">{{ $category->sort_order }}</td>
                                                            <td class="text-center">
                                                                 <label class="switch">
                                                                      <input type="checkbox"  class="switch-class"    data-name="addon-category"  data-id="{{$category->id}}" autocomplete="off"{{ $category->active==1 ? 'checked': '' }}>
                                                                      <span class="slider round"></span>
                                                                 </label>    
                                                            </td>
                                                            <td class="td-actions text-right" style="">
                                                                 <form action="{{ route('addoncategory.destroy', $category->id) }}"
                                                                      method="POST" class="form-inline float-right">
                                                                      <div class="table-icons">
                                                                           <a  title="Edit"
                                                                                class="table-action-edit"
                                                                                href="{{ route('addoncategory.edit', $category->id)}}"
