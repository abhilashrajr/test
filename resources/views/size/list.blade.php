          ...
          <div class="col-md-12">
               <div class="card">
                    <div class="card-header">
                         <h4 class="card-title" style="padding-left:20px;">Food Sizes</h4>
                    </div>
                    <div class="card-body">
                         <div class="bootstrap-table">
                              <div class="fixed-table-toolbar">
                                   ...
                                   <div class="columns columns-right pull-right mt-0" >
                                        <a href="{{ url('size/create') }}" style="font-size:16px;padding: 7px 20px;"
                                             ...
                                             <table id="bootstrap-table" class="table table-hover table-sm "
                                                  ...
                                                  <tbody>
                                                       ...
                                                       <tr>
                                                            ...
                                                            <label class="switch">
                                                                      <input type="checkbox"  class="switch-class"    data-name="size"  data-id="{{$category->id}}" autocomplete="off"{{ $category->active==1 ? 'checked': '' }}>
                                                                      <span class="slider round"></span>
                                                                 </label>
                                                            </td>
                                                            <td class="td-actions text-right" style="">
                                                                 <form action="{{ route('size.destroy', $category->id) }}"
                                                                      method="POST" class="form-inline float-right">
                                                                      <div class="table-icons">
                                                                           <a  title="Edit"
                                                                                class="table-action-edit"
                                                                                href="{{ route('size.edit', $category->id)}}"
