                    ...
                    <div class="col-md-10 offset-md-1" role="tablist">
                         ...
                         <div id="menu-category{{$category->id}}" class="menu-category" data-id="{{$category->id}}">
                              <div class="menu-category-title collapse-toggle" role="tab"
                                   ...
                                   aria-expanded="true">
                                   <div class="bg-image"><img src="{{ url('storage/app/public/images/'.$category->image)}}" alt="">
                                   </div>
                                        ...
                                        <div class="row align-items-center">
                                             <div class="col-sm-6 mb-2 mb-sm-0">
                                                  <h6 class="mb-0">{{$menu->name}} @if($menu->best_seller ==1)
                                                       <span class="badge badge-notify" style="font-size:10px;">Best
                                                            seller</span>@endif
                                                       @if($menu->veg ==1)
                                             ...
                                             <div class="col-sm-6 text-sm-right">
                                                  <span class="text-md mr-4"><span class="text-muted">from</span>  {{$restaurant->currency}}<span
          ...
          <div class="container">
               ...
               <div class="footer-first-row row">
                    <div class="col-lg-3 text-center">
                         <a href="index.html"><img src="{{ asset('themes') }}/soup/img/logo-light.svg" alt="" width="88"
                                   class="mt-5 mb-5"></a>
                    </div>
                    <div class="col-lg-4 col-md-6">
                         ...
                         <ul class="list-posts">
                              <li>
                                   <a href="blog-post.html" class="title">Link</a>
...
<div class="cartbtn" id="cart-btn">
     <a href="#" id="cart-icon" class=" d-none d-lg-block module module-cart right" data-toggle="panel-cart">
          <span class="cart-icon ">
               <i class="ti ti-shopping-cart  rounded-circle p-2 "
                    style="font-size:25px;color:#bbc4c6;background:#fff;border:1px solid #8a8989;"></i>
