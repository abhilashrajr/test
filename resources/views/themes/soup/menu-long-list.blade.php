          ...
          <div class="container">
               ...
               <div class="col-md-9" > 
                         ...
                         <div id="menu-category{{$category->id}}" class="menu-category " data-id="{{$category->id}}">
                              <div class="menu-category-title2 collapse-toggle" role="tab"
                                   data-target="#menuContent{{$category->id}}" data-toggle="collapse"
                                   aria-expanded="false">
                                  
                                   <h2 class="title " style="font-weight: 200;">{{$category->name}} <i class="collapse-icon fa fa-minus pull-right" style="font-size:30px;line-height:60px;font-weight:100;"></i></h2>
                              </div>
                              <div id="menuContent{{$category->id}}" class="menu-category-content collapse show">
                         ...
                         @if($cart["order_type"] == "deli_coll")
                         <p>"Dear Customer,If you have any allergy, Please give us a ring and speak to our management to discuss your requirement."</p>
                         @endif
                    </div>
               </div>
          </div>
...
$(document).ready(function() {
     ...
     @endphp
        ...
        $('.menu-category-title2').click(function() {
        ...
        if($(window).width() < 768) {
                ...
                $('.menu-category-title2').addClass('collapsed');
                $('i.collapse-icon').removeClass('fa-minus').addClass('fa-plus');
         }
