    ...
    <div class="row">
            <div class="col-xl-10 offset-xl-1 text-center">
                     <span class="icon icon-xl icon-success" style="height:auto;"><i class="ti ti-check-box"></i></span>
                        ...
                        <!--<h4 class="text-muted mb-5">Expected Delivery Time : @if(!empty($order_data->delivery_time)){{ date('h:i A', strtotime($order_data->delivery_time))}}@endif</h4>
                        <a href="{{route('home')}}" class="btn btn-outline-secondary"><span>Order Dine in</span></a>
-->
            </div>
        </div>
